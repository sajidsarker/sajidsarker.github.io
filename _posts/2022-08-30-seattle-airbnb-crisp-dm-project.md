...
**Figure 6.** *Heatmap of correlation between revenue and overall & composite ratings.*

At first glance, there is virtually no correlation between revenues generated by a host and the respective overall ratings and composite ratings guests score for a stay.
...
Bar certain amenities which are mandatory perhaps by Washington State laws such as fixtures of smoke detectors, carbon monoxide detectors, and fire extinguishers, the provision of amenities displayed in the table above in descending order of overall availability, indicates some of the most popular conveniences travellers to Seattle would be able to enjoy at an Airbnb.
